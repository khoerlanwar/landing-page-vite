<template>
  <main class="container">
    <ToastAlert :status="statusAlert" @result="alerts" />
    <section id="carousel">
      <Carousel />
    </section>
    ...
    <section id="product" class="py-4">
      <div class="py-2 flex justify-between items-center">
        ...
        <router-link to="/product">
          <div class="text-blue-600 text-xs lg:text-tiny">Lihat Semua</div>
        </router-link>
      </div>
      <div class="flex space-x-3 flex-nowrap overflow-auto py-4" id="category">
        <div v-for="items in product" :key="items.cart_id" id="product-card"
          class="min-w-[160px] lg:min-w-[280px] my-2 hover:shadow-lg hover:rounded-lg transition duration-800 delay-400 animation ease-in-out hover:p-2">
          <div class="flex w-full">
            <router-link :to="'product?q=' + items.cart_title">
    ...
    <section id="doctor" class="py-4">
      <div class="flex justify-center py-4">
        <div class="text-lg lg:text-3xl font-bold">Dokter Spesialis</div>
      </div>
      <div class="grid grid-cols-3 gap-3 mx-[100px]">
        <div class="min-w-[187px] m-auto">
          <img src="https://dummyimage.com/300x300/b8b8b8/34385e.png&text=Img+300x300" alt="" class="rounded-lg" />
          <div class="text-center my-2">
            <div class="font-bold text-lg">dr. Shakti, Sp.KK</div>
          </div>
        </div>
        <div class="min-w-[187px] m-auto">
          <img src="https://dummyimage.com/300x300/b8b8b8/34385e.png&text=Img+300x300" alt="" class="rounded-lg" />
