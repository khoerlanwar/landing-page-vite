<template>
  <main class="container p-4 mb-4">
    <div class="md:pt-header-h pt-m-header-h overflow-hidden">
      <div class="grid gap-4 lg:grid-cols-12 pt-[72px]">
        <!-- Article -->
        ...
        <!-- A Side -->
        <div class="lg:col-span-3 mobile:col-span-12 flex flex-col space-y-4">
          <div>
          ...
          <div>
            ...
            <div class="flex flex-wrap text-center">
              <a href="#" class="m-2">
                <span class="bg-slate-200 px-4 py-1 rounded-md">Aging</span>
              </a>
              <a href="#" class="m-2">
